 ...
 */
@Slf4j
public class PaymentDeferredBackExecuteListener implements ExecutionListener {

    private static final long serialVersionUID = -8794340459448230177L;

    @Override
    public void notify(DelegateExecution delegateExecution) {
        PaymentDeferredApplicationBpmApi paymentApi = SpringUtil.getBean(PaymentDeferredApplicationBpmApi.class);
        log.info("触发了计划延期申请退回任务，BusinessKey:{}", delegateExecution.getProcessInstanceBusinessKey());
