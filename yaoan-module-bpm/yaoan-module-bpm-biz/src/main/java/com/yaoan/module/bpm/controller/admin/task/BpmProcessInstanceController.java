...
import com.yaoan.module.bpm.controller.admin.task.vo.instance.*;
import com.yaoan.module.bpm.convert.task.BpmProcessInstanceConvert;
...
//    @PreAuthorize("@ss.hasPermission('bpm:process-instance:query')")
    public CommonResult<BpmProcessInstanceRespVO> getProcessInstance(@RequestParam("id") String id) {
        ...
        AtomicReference<AdminUserRespDTO> atomic = new AtomicReference<>();
        TenantUtils.executeIgnore(() -> {
            atomic.set(adminUserApi.getUser(NumberUtils.parseLong(processInstance.getStartUserId())));
        });
        AdminUserRespDTO startUser = atomic.get();
