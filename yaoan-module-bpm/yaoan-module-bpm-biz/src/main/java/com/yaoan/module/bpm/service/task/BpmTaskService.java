...
public interface BpmTaskService {
    ...
    void returnTaskV2(Long userId, BpmTaskReturnV2ReqVO reqVO);
    ...
    List<BpmTaskAllInfoRespVO> getAllTaskInfoRespByProcessInstanceIds(Long loginUserId, List<String> processInstanceIds);

    List<BpmTaskAllInfoRespVO> getAllTaskInfoRespByTaskIds(Long loginUserId, List<String> taskIds);

    /**
     * 将已审批的任务撤回来
     * */
    void withdrawal(WithDrawalReqVo reqVo);
}
