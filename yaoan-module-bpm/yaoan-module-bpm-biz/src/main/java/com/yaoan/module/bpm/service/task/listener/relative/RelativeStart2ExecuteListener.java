 ...
 */
@Slf4j
public class RelativeStart2ExecuteListener implements ExecutionListener {
    @Override
    public void notify(DelegateExecution delegateExecution) {
        RelativeBpmApi bpmApi = SpringUtil.getBean(RelativeBpmApi.class);
        log.info("触发了相对方SATRT2监听，BusinessKey:{}", delegateExecution.getProcessInstanceBusinessKey());
