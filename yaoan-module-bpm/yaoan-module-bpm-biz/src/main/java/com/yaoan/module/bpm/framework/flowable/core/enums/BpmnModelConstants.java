package com.yaoan.module.bpm.framework.flowable.core.enums;
...
public interface BpmnModelConstants {
    ...
    /**
     * BPMN UserTask 的扩展属性，用于标记流程发起人的公司id
     */
    String USER_TASK_PROCESS_INSTANCE_STARTER_COMPANY_ID = "processInstanceStarterCompanyId";
    /**
     * 流程扩展变量公司id
     */
    String USER_TASK_MAP_COMPANY_ID = "companyId";
    /**
     * 流程扩展变量参数
     */
    String USER_TASK_MAP_PARAM = "param";
