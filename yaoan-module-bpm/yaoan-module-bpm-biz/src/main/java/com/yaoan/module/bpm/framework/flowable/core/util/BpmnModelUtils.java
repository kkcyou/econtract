...
public class BpmnModelUtils {
    ...
    public static String parseStarterCompanyId(FlowElement userTask) {
        String candidateParam = userTask.getAttributeValue(
                BpmnModelConstants.NAMESPACE, BpmnModelConstants.USER_TASK_PROCESS_INSTANCE_STARTER_COMPANY_ID);
        if (candidateParam == null) {
            ExtensionElement element = CollUtil.getFirst(userTask.getExtensionElements().get(BpmnModelConstants.USER_TASK_PROCESS_INSTANCE_STARTER_COMPANY_ID));
