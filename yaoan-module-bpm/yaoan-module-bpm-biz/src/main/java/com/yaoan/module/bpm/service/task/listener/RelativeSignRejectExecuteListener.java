 ...
 */
@Slf4j
public class RelativeSignRejectExecuteListener implements ExecutionListener {
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        contractApi.updateRelativeSignReject(delegateExecution.getProcessInstanceId(), "SIGN");
