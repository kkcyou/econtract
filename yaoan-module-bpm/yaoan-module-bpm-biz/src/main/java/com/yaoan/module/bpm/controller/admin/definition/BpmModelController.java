package com.yaoan.module.bpm.controller.admin.definition;
...
import com.yaoan.module.bpm.service.definition.BpmCategoryService;
...
public class BpmModelController {
    ...
    public CommonResult<BpmModelListRespVO> getModelList() {
        return success(modelService.getModelList());
    }


    @GetMapping("/simple/getModelBykey")
    @Operation(summary = "根据流程定义，获得流程模型")
    @Parameter(name = "key", description = "根据流程定义，获得流程模型", required = true, example = "contract_approve")
    public CommonResult<BpmModelRespVO> getSimpleModelBykey(@RequestParam("key") String key){
        return success(modelService.getSimpleModelBykey(key));
    }
}
