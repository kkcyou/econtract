...
//    private final String frontDec;
    ...
    public static BpmProcessInstanceResultEnum getInstance(Integer code) {
        for (BpmProcessInstanceResultEnum value : BpmProcessInstanceResultEnum.values()) {
