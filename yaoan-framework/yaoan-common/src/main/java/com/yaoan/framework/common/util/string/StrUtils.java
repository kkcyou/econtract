package com.yaoan.framework.common.util.string;
...
public class StrUtils {
    ...
    public static  Map<String, String> splitToMap(String mapStr, String keySeparator,String valueSeparator ) {
        // 使用Hutool的StrUtil.split()方法先分割键值对
        List<String> keyValuePairs = StrUtil.split(mapStr, keySeparator);
        // 创建一个Map来存储解析的结果
