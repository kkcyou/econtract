package com.yaoan.framework.operatelog.core.aop;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.yaoan.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.yaoan.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.yaoan.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.yaoan.framework.operatelog.core.annotations.OperateLog operateLog,
                           Operation operation) throws Throwable {
        // 目前，只有管理员，才记录操作日志！所以非管理员，直接调用，不进行记录
        Integer userType = WebFrameworkUtils.getLoginUserType();
        if (!Objects.equals(userType, UserTypeEnum.ADMIN.getValue()) && !Objects.equals(userType, UserTypeEnum.ANONYMOUS.getValue())) {
    ...
    private void log(ProceedingJoinPoint joinPoint,
        ...
        try {
            // TODO
            if (UserTypeEnum.ANONYMOUS.getValue().equals(WebFrameworkUtils.getLoginUserType())){
                // 如果是匿名用户访问。则记录该会话的所有操作
                this.logAnonymous(joinPoint, operateLog, operation, startTime, result, exception);
                return;
            }
            // 判断不记录的情况
    ...
    private void logAnonymous(ProceedingJoinPoint joinPoint,
                      com.yaoan.framework.operatelog.core.annotations.OperateLog operateLog,
                      Operation operation,
                      LocalDateTime startTime, Object result, Throwable exception) {
        OperateLog operateLogObj = new OperateLog();
        ...
        // 异步记录日志
        operateLogFrameworkService.createAnonymousOperateLog(operateLogObj);
    }
