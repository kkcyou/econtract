package com.yaoan.framework.tenant.core.security;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (user != null) {
            ...
            if (tenantId == null) {
                ...
                Integer packageType = tenantFrameworkService.getTenantPackageType(tenantId);
                user.setTenantPackageType(packageType);
