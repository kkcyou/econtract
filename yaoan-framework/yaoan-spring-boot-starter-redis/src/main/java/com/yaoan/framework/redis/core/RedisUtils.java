package com.yaoan.framework.redis.core;
...
public final class RedisUtils {
    ...
    public RedisUtils setRedisTemplate(RedisTemplate redisTemplate) {
    ...
    public boolean expire(String key, long time) {
        try {
            ...
            log.error("RedisUtils is exception", e);
            return false;
        }
    }
     ...
     * @return
     */
    public <K, V> Map<K, V> mGetToMap(Collection<K> keys) {
        List<V> cacheList = this.mGet(keys);
        Map<K, V> cacheMap = new LinkedHashMap<>();
    ...
    public <T> Long pfAdd(String key, T value, Long time) {
        try {
