package com.yaoan.framework.sms.core.client.impl;

import com.yaoan.framework.sms.core.client.SmsClient;
import com.yaoan.framework.sms.core.client.SmsClientFactory;
import com.yaoan.framework.sms.core.client.impl.aliyun.AliyunSmsClient;
import com.yaoan.framework.sms.core.client.impl.debug.DebugDingTalkSmsClient;
import com.yaoan.framework.sms.core.client.impl.shanxi.ShanXiSmsClient;
import com.yaoan.framework.sms.core.client.impl.tencent.TencentSmsClient;
import com.yaoan.framework.sms.core.enums.SmsChannelEnum;
...
public class SmsClientFactoryImpl implements SmsClientFactory {
    ...
    private AbstractSmsClient createSmsClient(SmsChannelProperties properties) {
        ...
        // 创建客户端
        switch (channelEnum) {
            case ZC_SHANXI_XIAN: return new ShanXiSmsClient(properties);
