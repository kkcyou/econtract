package com.yaoan.framework.mybatis.core.interceptor;
...
public class SqlInterceptor implements Interceptor {
	...
	private boolean enableExecutorTime = true;

	@Override
	public Object intercept(Invocation invocation) throws Throwable {
//		StatementHandler target = (StatementHandler) invocation.getTarget();
//		String sql1 = target.getBoundSql().getSql();
...
//		 获取执行方法的MappedStatement参数,不管是Executor的query方法还是update方法，第一个参数都是MappedStatement
		...
		if(sql!=null && sql.indexOf("system_operate_log") > -1){
			return re;
		}
		System.out.println(sqlId + " 方法对应sql执行语句:" +sql);
		// 打印mysql执行时间
