...
public interface OAuth2ClientService {
     ...
     * @return OAuth2 客户端
     */
    OAuth2ClientDO getOAuth2Client(String clientId,String clientSecret);
     ...
     * @return 编号
     */
    Long createOAuth2ClientV2(@Valid OAuth2ClientCreateReqVO createReqVO);
     ...
     * @param updateReqVO 更新信息
     */
    void  updateOAuth2ClientV2( OAuth2ClientUpdateReqVO updateReqVO);

    /**
     * 获取客户分页列表
     */
    PageResult<OAuth2ClientV2RespVO> getOAuth2ClientPageV2( OAuth2ClientPageReqVO pageVO);
    /**
     * 刷新secret
     */
    void  refreshSecret( Long id);
    /**
     * 获取客户端详情
     */
    OAuth2ClientRespVO getOAuth2ClientV2(Long id);
