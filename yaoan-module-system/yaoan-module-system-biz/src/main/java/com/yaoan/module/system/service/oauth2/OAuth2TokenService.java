...
public interface OAuth2TokenService {
     ...
     * @return 访问令牌的信息
     */
    OAuth2AccessTokenDO createAccessToken(Long userId, Integer userType, String clientId,Long companyId, List<String> scopes);
     ...
     * @return 访问令牌的信息
     */
    OAuth2AccessTokenDO createBusinessKeyAccessToken(String userId, Integer userType, String clientId, List<String> scopes);
     ...
     * @return 访问令牌的信息
     */
    OAuth2AccessTokenDO refreshExtendAccessToken(String refreshToken);
