...
public interface PermissionService {
    ...
    void assignRoleMenuWithTenantId(Long roleId, Set<Long> menuIds, Long tenantId);
    ...
    void assignUserRoleWithTenantId(Long userId, Set<Long> roleIds, Long tenantId);
     ...
     * @return 用户编号集合
     */
    Set<Long> getUserRoleIdListByRoleIdV2(Collection<Long> roleIds);
    ...
    Set<Long> selectListByRoleIdsAndCompanyId(Collection<Long> roleIds);
