package com.yaoan.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.yaoan.adminserver.UserController.save(...)")
