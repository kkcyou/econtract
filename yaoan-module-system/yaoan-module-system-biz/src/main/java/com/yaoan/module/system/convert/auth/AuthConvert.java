...
public interface AuthConvert {
    ...
    AuthTokenRespVO convert2Token(OAuth2AccessTokenDO bean);
    ...
    LoginRespVO convert(AdminUserDO user);

    AuthLoginRespVO convert(LoginRespVO loginRespVO);

    AuthLoginRespDTO convertDo2Dto(OAuth2AccessTokenDO accessTokenDO);
}
