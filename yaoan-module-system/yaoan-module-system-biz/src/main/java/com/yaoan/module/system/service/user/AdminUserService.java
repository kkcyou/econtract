...
public interface AdminUserService {
     ...
     * @param authVo 重置账户信息
     */
    void activeUser(AuthActiveUserReqVO authVo);
    ...
    void changeUserPassword(UserForgetPasswordReqVO changePasswordReqVO);
    ...
    AdminUserDO getUserByUsernameOrMobile(String username);
     ...
     * @return 用户对象信息
     */
    AdminUserDO getUserByAppOpenId(String openId);
     ...
     * @return 用户列表
     */
    List<AdminUserDO> getUserList2(List<Long> ids);
    ...
    void validateUserForCreateOrUpdateForOrg(Long id, String username, String mobile, String email,
    ...
    List<AdminUserDO> getUserListByRoleId(Long roleId);
     ...
     * 根据部门id获取公司信息
     */
    UserCompanyDeptRespDTO getCompany(UserCompanyDeptRespDTO userCompanyDeptRespDTO,Long deptId);
    /**
     * 获取所有用户信息
     */
    List<AdminUserRespDTO> getUserList();
    AdminUserRespDTO getUserByPlatformUserId(String planformUserId);
    List<AdminUserRespDTO> getUserListLikeNickname(String nickname);
    List<DeptUserRespVO> getDeptAndUserList();
    ...
    List<AdminUserRespDTO> selectListByCompanyIds(List<Long> companyIds);
     ...
     * @return
     */
    List<AdminUserDO> getUserNickListById(List<Long> userIds);

    List<AdminUserDO> getCompanyUserList(Integer status);

    List<DeptTreeVO> getCompanyUserTreeList(Integer status);
    List<AdminUserDO> getUsersByPlatformUserId(String userId);

    String getUserNickById(Long userId);

    List<RoleSimple4UserRespVO> getRoleUserList();
