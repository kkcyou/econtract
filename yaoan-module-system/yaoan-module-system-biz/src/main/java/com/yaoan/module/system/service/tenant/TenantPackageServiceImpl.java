...
import com.yaoan.module.system.convert.tenant.TenantPackageConvert;
...
public class TenantPackageServiceImpl implements TenantPackageService {
    ...
    public Long createTenantPackage(TenantPackageCreateReqVO createReqVO) {
        //校验租户名称不可重复
        isNameExist(null, createReqVO.getName());
        // 插入
     ...
     * @return
     */
    public void isNameExist(Object id, String name) {
        LambdaQueryWrapperX<TenantPackageDO> tenantPackageDOLambdaQueryWrapperX = new LambdaQueryWrapperX<TenantPackageDO>().eqIfPresent(TenantPackageDO::getName, name).neIfPresent(TenantPackageDO::getId, id);
        boolean nameFlag = tenantPackageMapper.selectCount(tenantPackageDOLambdaQueryWrapperX) > 0;
        if (nameFlag) {
