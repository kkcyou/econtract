...
public interface NotifySendService {
     ...
     * @return 发送日志编号
     */
    Long sendSingleNotifyToAdminV2(Long userId,
                                 String templateCode,String modelName, Map<String, Object> templateParams);
    /**
     * 发送单条站内信给用户 APP 的用户
     *
    ...
    Long sendSingleNotify( Long userId, Integer userType,
                           String templateCode, Map<String, Object> templateParams);
    Long sendSingleNotifyV2( Long userId, Integer userType,
                           String templateCode,String modelName, Map<String, Object> templateParams);
    Long sendSingleNotifyForWarning( Long userId,Long tenantId, Integer userType,
                           String templateCode, Map<String, Object> templateParams, Map warningMap);
