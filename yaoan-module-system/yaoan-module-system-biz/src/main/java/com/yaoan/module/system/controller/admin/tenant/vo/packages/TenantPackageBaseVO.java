package com.yaoan.module.system.controller.admin.tenant.vo.packages;
...
public class TenantPackageBaseVO {
    ...
    @Schema(description = "套餐类型，参见 TenantPackageTypeEnum 枚举", requiredMode = Schema.RequiredMode.REQUIRED, example = "0")
