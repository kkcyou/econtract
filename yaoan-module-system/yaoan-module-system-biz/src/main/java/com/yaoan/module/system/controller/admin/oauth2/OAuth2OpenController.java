...
import com.yaoan.framework.common.util.http.HttpUtils;
...
import com.yaoan.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.yaoan.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.yaoan.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.yaoan.module.system.convert.oauth2.OAuth2OpenConvert;
import com.yaoan.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.yaoan.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
...
import com.yaoan.module.system.service.oauth2.OAuth2ApproveService;
import com.yaoan.module.system.service.oauth2.OAuth2ClientService;
import com.yaoan.module.system.service.oauth2.OAuth2GrantService;
import com.yaoan.module.system.service.oauth2.OAuth2TokenService;
import com.yaoan.module.system.util.oauth2.OAuth2Utils;
...
import static com.yaoan.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
public class OAuth2OpenController {
    ...
    public CommonResult<OAuth2OpenAccessTokenRespVO> postAccessToken(HttpServletRequest request,
                                                                     ...
                                                                     @RequestParam(value = "userId", required = false) String userId, // 用户id模式
        ...
        OAuth2ClientDO client = null;
        if (OAuth2GrantTypeEnum.USERID_TOKEN.equals(grantTypeEnum)) {
            ...
            client = oauth2ClientService.getOAuth2ClientFromCache(SecurityFrameworkUtils.getClientInfo().getClientId());
        } else {
            // 1.2 校验客户端
            String[] clientIdAndSecret = obtainBasicAuthorization(request);
            client = oauth2ClientService.validOAuthClientFromCache(clientIdAndSecret[0], clientIdAndSecret[1],
        ...
        switch (grantTypeEnum) {
            case AUTHORIZATION_CODE:
                accessTokenDO = oauth2GrantService.grantAuthorizationCodeForAccessToken(client.getClientId(), code, redirectUri, state, (Long) JSONObject.parseObject(client.getAdditionalInformation(), Map.class).get("companyId"));
                break;
            case PASSWORD:
            ...
            case REFRESH_TOKEN:
                ...
                break;
            case USERID_TOKEN:
                accessTokenDO = oauth2GrantService.grantUserIdToken(client, userId, scopes);
                break;
            default:
    ...
    public CommonResult<String> approveOrDeny(@RequestParam("response_type") String responseType,
        ...
        if (grantTypeEnum == OAuth2GrantTypeEnum.AUTHORIZATION_CODE) {
            return success(getAuthorizationCodeRedirect(getLoginUserId(), client, approveScopes, redirectUri, state, getLoginUser().getCompanyId()));
        }
        // 3.2 如果是 token 则是 implicit 简化模式，则发送 accessToken 访问令牌，并重定向
        return success(getImplicitGrantRedirect(getLoginUserId(), client, approveScopes, redirectUri, state, getLoginUser().getCompanyId()));
    }
    ...
    private String getImplicitGrantRedirect(Long userId, OAuth2ClientDO client,
                                            List<String> scopes, String redirectUri, String state, Long companyId) {
        // 1. 创建 access token 访问令牌
        OAuth2AccessTokenDO accessTokenDO = oauth2GrantService.grantImplicit(userId, getUserType(), client.getClientId(), scopes, companyId);
        Assert.notNull(accessTokenDO, "访问令牌不能为空"); // 防御性检查
        // 2. 拼接重定向的 URL
