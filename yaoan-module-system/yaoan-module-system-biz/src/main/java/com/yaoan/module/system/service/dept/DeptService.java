...
public interface DeptService {
    ...
    Long createDept(DeptCreateReqVO reqVO, Long tenantId);
    ...
    List<DeptDO> getListAllSimpleBy( List<RelativeContactDTO> relativeContactDTOS );
    /**
     * 获取顶级部门列表-父级部门id为0的
     * @return
     */
    List<DeptDO> getParentDeptList( );
    ...
    List<DeptDO> getDeptListByCompanyId(Long companyId);
}
