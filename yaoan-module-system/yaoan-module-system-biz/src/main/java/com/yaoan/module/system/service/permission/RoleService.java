...
public interface RoleService {
    ...
    Long createRoleWithTenantId(@Valid RoleCreateReqVO reqVO, Integer type, Long tenantId);
    ...
    RoleRespDTO getRoleRespDTOByUserId(Long userId);
    List<RoleRespDTO> getRoleRespDTOSByUserId(Long userId);
