...
import com.yaoan.module.system.mq.message.sms.SmsSendMessage;
import com.yaoan.module.system.mq.producer.sms.SmsProducer;
...
public class SmsSendServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testDoSendSms() {
        ...
        when(smsClient.sendSms(eq(message.getLogId()), eq("15230672620"), eq(message.getApiTemplateId()),
                eq(message.getTemplateParams()), eq(message.getContent()))).thenReturn(sendResult);

        // 调用
        message.setMobile("15230672620");
        message.setContent("123xxx");
