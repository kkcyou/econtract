...
public class RoleServiceImplTest extends BaseDbUnitTest {
    ...
    public void testValidateRoleDuplicate_success() {
        // 调用，不会抛异常
        roleService.validateRoleDuplicate(randomString(), randomString(), null,getLoginUser().getCompanyId());
    }
    ...
    public void testValidateRoleDuplicate_nameDuplicate() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> roleService.validateRoleDuplicate(name, randomString(), null,getLoginUser().getCompanyId()),
    ...
    public void testValidateRoleDuplicate_codeDuplicate() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> roleService.validateRoleDuplicate(randomString(), code, null,getLoginUser().getCompanyId()),
