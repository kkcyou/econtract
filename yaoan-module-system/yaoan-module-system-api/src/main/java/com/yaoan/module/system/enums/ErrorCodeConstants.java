package com.yaoan.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_LOGIN_PLATFORM_DISABLED = new ErrorCode(1002000002, "登录失败，登录平台被禁用");
    ...
    ErrorCode AUTH_FIRST_LOGIN = new ErrorCode(1002000008, "首次登录需要重置密码，激活账户");
    ErrorCode AUTH_SAME_PASSWORD = new ErrorCode(1002000009, "新密码不可与初始密码一致");
    ErrorCode AUTH_LOGIN_VERI_CODE_ERROR = new ErrorCode(1002000010, "验证码不正确");
    ErrorCode AUTH_LOGIN_SAME_MOBILE = new ErrorCode(1002000011, "手机号与登录手机号不一致");
    ...
    ErrorCode DEPT_NOT_HANDLE = new ErrorCode(1002004008, "无权操作该部门");
    ...
    // ========== 单位模块 1002009000 ==========
    ErrorCode COMPANY_NOT_FOUND = new ErrorCode(1002009000, "当前单位不存在");
    ErrorCode COMPANY_NOT_ENABLE = new ErrorCode(1002009001, "单位({}) 不处于开启状态，不允许选择");
    ErrorCode COMPANY_NAME_DUPLICATE = new ErrorCode(1002009002, "已经存在该名字的单位");
    ErrorCode COMPANY_CODE_DUPLICATE = new ErrorCode(1002009003, "已经存在该信用代码的单位");
    ...
    // ========== 内蒙 1002029000 ==========
    ErrorCode UN_USED_DATA_ERROR = new ErrorCode(1002029000, "未检测到可用供应商数据");
