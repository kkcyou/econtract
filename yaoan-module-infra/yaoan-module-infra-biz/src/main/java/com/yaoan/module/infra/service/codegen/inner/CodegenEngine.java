package com.yaoan.module.infra.service.codegen.inner;
...
import com.yaoan.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "yaoan-module-${table.moduleName}/" + // 顶级模块
                "yaoan-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "yaoan-module-${table.moduleName}/" + // 顶级模块
                "yaoan-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "yaoan-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "yaoan-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
