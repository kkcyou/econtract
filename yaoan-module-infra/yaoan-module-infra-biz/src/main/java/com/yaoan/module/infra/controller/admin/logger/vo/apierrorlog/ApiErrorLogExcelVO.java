package com.yaoan.module.infra.controller.admin.logger.vo.apierrorlog;

import com.yaoan.framework.excel.core.annotations.DictFormat;
import com.yaoan.framework.excel.core.convert.DictConvert;
import com.yaoan.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(com.yaoan.module.system.enums.DictTypeConstants.USER_TYPE)
