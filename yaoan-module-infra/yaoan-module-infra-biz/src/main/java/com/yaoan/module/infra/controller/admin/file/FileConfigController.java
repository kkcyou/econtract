...
import com.yaoan.module.infra.controller.admin.file.vo.config.*;
...
import com.yaoan.module.infra.service.file.FileConfigService;
...
public class FileConfigController {
    ...
    @GetMapping("/getFileConfigList")
    @Operation(summary = "获得文件配置列表")
    public CommonResult<List<FileConfigListRespVO>> getFileList() {
        List<FileConfigDO> pageResult = fileConfigService.getFileList();
        return success(FileConfigConvert.INSTANCE.convertList01(pageResult));
    }
}
