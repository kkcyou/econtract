...
import com.yaoan.framework.test.core.ut.BaseDbUnitTest;
import com.yaoan.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import com.yaoan.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.yaoan.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.yaoan.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.yaoan.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.yaoan.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.yaoan.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.yaoan.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.yaoan.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.yaoan.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.yaoan.framework.test.core.util.AssertUtils.assertServiceException;
import static com.yaoan.framework.test.core.util.RandomUtils.randomLongId;
import static com.yaoan.framework.test.core.util.RandomUtils.randomPojo;
import static com.yaoan.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.yaoan.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("yaoan-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("yaoan-test");
