...
public interface ErrorCodeConstants {
    ...
    // ========== 权限不足 1001008000 ==========
    ErrorCode DATA_ROLE_ERROR = new ErrorCode(1001008000, "权限不足，仅允许监管下载");
    ErrorCode CONFIG_ROLE_ERROR = new ErrorCode(1001008001, "{}");
    ErrorCode DIY_ERROR = new ErrorCode(1003009999, "{}");
}
