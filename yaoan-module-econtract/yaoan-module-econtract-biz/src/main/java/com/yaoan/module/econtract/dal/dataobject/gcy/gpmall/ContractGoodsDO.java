...
/**
 * @description: 合同关联标的（商品）表
 * @author: zhc
 * @date: 2024/03-18
 */
@Data
@TableName("ecms_neimeng_contract_goods")
public class ContractGoodsDO extends BaseDO {
    /**
     ...
     * 分包的唯一识别码
     */
    @Schema(description = "分包的唯一识别码", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
