...
/**
 * <p>CheckFileCallBackHY complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="CheckFileCallBackHY"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CheckFileCallBackHY1", propOrder = {
    "caseID",
    "documentData",
    "sign",
    "callBackService",
...
public class CheckFileCallBackHY {
