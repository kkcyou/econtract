...
/**
 * @description: 交易的合同采购内容（合同明细）
 * @author: Pele
 * @date: 2024/8/1 10:01
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("ecms_gpx_contract_quotation_rel")
public class GPXContractQuotationRelDO extends BaseDO {

    private static final long serialVersionUID = 3850413688510298113L;
