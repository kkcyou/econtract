...
import com.yaoan.module.econtract.controller.admin.contract.vo.ContractInfoVO;
 ...
 * @description:
 * @author: Pele
 * @date: 2025-5-19 15:48
 */
public class LedgerQueryRespVO extends ContractBaseVO {

    private static final long serialVersionUID = -8910745421029870755L;
    /**
     * 合同变动信息
     */
    List<BpmContractChangeDO> contractChangeList;
    /**
     * 签署流程信息
     */
