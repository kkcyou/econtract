...
public class ApiInfoRespVO implements Serializable {
     ...
     * 模板参数集合
     */
    @Schema(description = "模板参数集合", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private List<ContractParameterRespDO> contractParameterList;
