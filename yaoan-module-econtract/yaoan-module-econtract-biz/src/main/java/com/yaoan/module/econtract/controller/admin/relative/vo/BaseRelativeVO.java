 ...
 */
@Data
public class BaseRelativeVO extends FlowableParam {
    ...
    private String name;
    @Schema(description = "是否仅本租户使用，0 是 1否", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    private List<RelativeContact> relativeContactList ;
