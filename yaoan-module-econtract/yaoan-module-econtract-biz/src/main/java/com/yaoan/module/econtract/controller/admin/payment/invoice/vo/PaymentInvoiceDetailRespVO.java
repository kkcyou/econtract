...
@Schema(description = "管理后台 - 发票信息明细 Response VO")
@Data
@ExcelIgnoreUnannotated
public class PaymentInvoiceDetailRespVO {

    @Schema(description = "发票明细主键", requiredMode = Schema.RequiredMode.REQUIRED, example = "9788")
