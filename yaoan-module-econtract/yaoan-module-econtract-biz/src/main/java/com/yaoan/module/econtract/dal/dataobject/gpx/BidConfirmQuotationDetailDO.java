...
@TableName("ecms_gpx_bid_confirm_quotation_detail")
public class BidConfirmQuotationDetailDO extends BaseDO {
    private static final long serialVersionUID = 37796706652315722L;
