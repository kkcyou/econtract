 ...
 * @description:
 * @author: Pele
 * @date: 2023/9/13 20:09
 */
@Schema(description = "模板审批页面展示 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
public class ModelBpmPageReqVO extends PageParam {

    private static final long serialVersionUID = 5271127022621789944L;

    @Schema(description = "模板名称、创建人姓名", requiredMode = Schema.RequiredMode.REQUIRED)
     ...
     * 查询审批通过时间范围的起始时间
     */
    @Schema(description = "查询审批通过时间范围的起始时间", example = "2023-08-01 01:00:00")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone="GMT+8")
     ...
     * 查询审批通过时间范围的结束时间
     */
    @Schema(description = "查询审批通过时间范围的结束时间", example = "2023-08-01 03:00:00")
    @JsonFormat(timezone="GMT+8")
