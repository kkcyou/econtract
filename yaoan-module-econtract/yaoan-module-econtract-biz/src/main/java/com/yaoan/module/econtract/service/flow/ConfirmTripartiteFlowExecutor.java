 ...
 */
@Component
public class ConfirmTripartiteFlowExecutor implements FlowExecutor {

    @Resource
    private BpmProcessInstanceApi processInstanceApi;

    public static final String PROCESS_KEY = "ecms_contract_comfirm_sign_tripartite";
    ...
    public String execute(List<Long> userIds, String businessKey) {
        ...
        processInstanceVariables.put("assign1", userIds.get(1));
        processInstanceVariables.put("assign2", userIds.get(2));
        processInstanceVariables.put("assign3", userIds.get(3));
        processInstanceVariables.put("assign4", userIds.get(4));
        processInstanceVariables.put("assign5", userIds.get(5));
