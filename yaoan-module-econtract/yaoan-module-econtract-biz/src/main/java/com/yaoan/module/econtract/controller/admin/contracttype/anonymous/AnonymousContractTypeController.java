package com.yaoan.module.econtract.controller.admin.contracttype.anonymous;
...
@Slf4j
@RestController
@RequestMapping("anonymous/econtract/contracttype")
@Validated
@Tag(name = "(匿名访问)合同类型模块", description = "合同类型模块")
public class AnonymousContractTypeController {
