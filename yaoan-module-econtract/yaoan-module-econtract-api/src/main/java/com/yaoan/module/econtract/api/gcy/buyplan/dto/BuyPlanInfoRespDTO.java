 ...
 */
@Data
public class BuyPlanInfoRespDTO implements Serializable {

    private static final long serialVersionUID = 3483121214135238497L;
    ...
    private List<BuyPlanPackageDTO> buyPlanPackage;

    private List<BuyPlanAttachmentDTO> attachmenList;
