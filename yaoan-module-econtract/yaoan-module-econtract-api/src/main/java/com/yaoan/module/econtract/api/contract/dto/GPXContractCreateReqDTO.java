 ...
 */
@Data
public class GPXContractCreateReqDTO extends BaseDTO{
    ...
    private List<PurchaseDTO> purchaseVOList;
...
//    private Date goodsWarrantyEndDate;
    ...
    @Schema(description = "上传合同", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    private List<TradingSupplierDTO> tradingSupplierVOList;
    ...
    private List<GPXPaymentPlanDTO> paymentPlanList;
    ...
    private List<GPXContractQuotationRelDTO> quotationRelReqVOList;
...
//    private Integer infewdays;
    ...
    private String contractDrafterStr;
