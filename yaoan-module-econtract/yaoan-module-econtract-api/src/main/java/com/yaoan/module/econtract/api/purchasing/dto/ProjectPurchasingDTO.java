 ...
 */
@Data
public class ProjectPurchasingDTO implements Serializable {

    private static final long serialVersionUID = -327254802713583373L;
     ...
     * 合同采购内容
     */
    private List<ContractPurchaseContentPro> contractPurchaseContentList;
