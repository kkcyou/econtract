 ...
 */
@Data
public class ContractOrderExtDTO extends BaseDTO{
...
//    private Date workEndDate;
    ...
    /**
     * 是否发送产品  0 默认未发送   1已发送  2审批通过
     */
    @Schema(description = "是否发送产品  0 默认未发送   1已发送  2审批通过", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    // 合同条款信息
    private List<ContractTermDTO> terms;
}
